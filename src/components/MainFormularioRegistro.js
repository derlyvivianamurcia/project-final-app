              ...
              <div className="card card-signin my-5">
                <div className="card-body">
                  ...
                  <form className="form-signin" onSubmit={this.handleSubmit}>
                    ...
                    <div class="form_linea form-row">
                      <div class="form_texto">
                        <p>Teléfono celular<span>*</span></p>
                      </div>
                      ...
                      <div class="form_inputs tres_inputs col-md form-group">
                        <input
                          ...
                          id="telf12"
                          class="form-control"
                          data-msg-number="Introduzca un número de teléfono válido"
                    ...
                    <div className="form-row">
                      <div className="form-group col-md-6">
                        ...
                        <select id="inputState" className="form-control" name="departamento">
                      ...
                      <div className="form-group col-md-6">
                        ...
                        <select id="inputState" className="form-control" name="municipio">
                    ...
                    <div class="form_linea">
                      ...
                      <div class="form_inputs">
                        <input
                          onChange={this.handleChange}
                          type="radio" id="shombre" name="genero1"
                          value={this.state.form.genero1} />
                        <label for="shombre">Hombre</label>
                        <input
                          onChange={this.handleChange}
                          type="radio" id="smujer" name="genero2" checked="" value={this.state.form.genero2} />
                        <label for="smujer">Mujer</label>
                      </div>
                    </div>
                    ...
                    <div class="form_linea">
                      ...
                      <div class="form_inputs">
                        <input
                          onChange={this.handleChange}
                          name="direccion" type="text" id="ContainerGeneralOverWrite_ContainerGeneral_direccion" class="cm-12 form-control"
                      ...
                      <div class="box">
                        <div class="form_linea">
                          ...
                          <div class="form_inputs form_full">
                            <input
                              onChange={this.handleChange}
                              name="titulo" type="text" maxlength="100" id="ContainerGeneralOverWrite_ContainerGeneral_titulo" class="cm-12 form-control" data-msg-maxlength=" " placeholder="Ej: Analista de crédito y riesgo"
                          ...
                          <div class="mas_exp">
                            <div class="no_expprof form_linea" >
                              <label id="lblexperienciapro">
                                <input
                                  onChange={this.handleChange}
                                  type="checkbox" id="experienciapro" name="experienciapro"
                                  value={this.state.form.experienciapro}
                                />No tengo ninguna experiencia</label>
                            </div>
                          </div>
                                ...
                                <div class="form_linea">
                                  ...
                                  <div class="form_inputs pos_rel">
                                    ...
                                    <div>
                                      <input
                                        onChange={this.handleChange}
                                        type="text" id="ep-empresa" name="empresaExperiencia" class="cm-12 ep-empresa form-control" maxlength="100" data-autocomplete-extraparams="GetCompanyExtraParams" data-autocomplete-idholder="xp-empresa" data-autocomplete-method="GET" data-autocomplete-url="https://api-sug.computrabajo.com/company/get" autocomplete="off"
                                    ...
                                    <div class="form_linea">
                                      ...
                                      <div class="form_inputs pos_rel">
                                        <div class="col-md-4 form-group">
                                          <select id="fnacimiento-dia" class="cm-5 form-control" name="tiempoEmpresa" ><option value="0">Tiempo</option><option value="1">1</option><option value="2">2</option><option value="3">3</option><option value="4">4</option><option value="5">5</option><option value="6">6</option><option value="7">7</option><option value="8">8</option><option value="9">9</option><option value="10">10</option><option value="11">11</option><option value="12">12</option><option value="13">13</option><option value="14">14</option><option value="15">15</option><option value="16" selected="">16</option><option value="17">17</option><option value="18">18</option><option value="19">19</option><option value="20">20</option><option value="21">21</option><option value="22">22</option><option value="23">23</option><option value="24">24</option><option value="25">25</option><option value="26">26</option><option value="27">27</option><option value="28">28</option><option value="29">29</option><option value="30">30</option><option value="31">31</option></select></div>
                                  ...
                                  <div class="form_linea">
                                    ...
                                    <div class="form_inputs pos_rel">
                                      ...
                                      <div>
                                        <input
                                          onChange={this.handleChange}
                                          type="text" id="ep-cargo" class="cm-12 form-control" name="cargoEmpresa" maxlength="50" data-autocomplete-extraparams="GetCargosExtraParams" data-autocomplete-idholder="idcargo" data-autocomplete-method="POST" data-autocomplete-url="/ajax/getprofessions" autocomplete="off" 
